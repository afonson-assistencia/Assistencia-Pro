...
import { LayoutDashboard, Users, ClipboardList, Package, ShoppingCart, LogOut, Menu, X, Receipt, Moon, Sun, ShieldCheck, Download } from 'lucide-react';
    ...
    <div className="flex min-h-screen bg-[var(--bg-main)]">
      ...
      <aside className="fixed inset-y-0 left-0 hidden w-64 border-r border-[var(--border-color)] bg-[var(--bg-card)] md:block">
        <div className="flex h-16 items-center gap-3 border-b border-[var(--border-color)] px-6">
          ...
          <span className="text-xl font-bold text-[var(--text-main)]">Assistência Pro</span>
        </div>
      ...
      <div className="flex flex-1 flex-col md:pl-64">
        ...
        <header className="flex h-16 items-center justify-between border-b border-[var(--border-color)] bg-[var(--bg-card)] px-4 md:hidden">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold text-[var(--text-main)]">Assistência Pro</span>
          </div>
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="rounded-md p-2 text-[var(--text-muted)] hover:bg-slate-100 dark:hover:bg-slate-800"
            >
