...
import { Save, Building2, Image as ImageIcon, CheckCircle2, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-[var(--text-muted)]">Personalize a identidade da sua assistência.</p>
      </div>
